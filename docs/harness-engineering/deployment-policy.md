...
| 1.2 | 테스트 명령 ($BACKEND_TEST_CMD, 예: pytest/pnpm test/gradle test) 전체 통과 | CI 결과 또는 로컬 재실행 | **배포 차단** |
...
|------|------------|------------|
| CI 통과 | BLOCK | BLOCK |
| 테스트 명령 ($BACKEND_TEST_CMD, 예: pytest/pnpm test/gradle test) 통과 | BLOCK | BLOCK (타겟 테스트만) |
